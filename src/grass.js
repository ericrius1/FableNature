...
import { terrainHeight, fbm } from './terrain.js';

export function createGrass(count = 90000, radius = 42) {
  ...
  // Wind: phase carries world-position info so gusts move in waves.
  ...
  while (i < count && guard++ < count * 6) {
    ...
    // patchy coverage: thin the grass out over dirt-ish areas
